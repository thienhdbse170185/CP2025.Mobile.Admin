...
abstract class $VaccineScheduleLogResponseCopyWith<$Res> {
  factory $VaccineScheduleLogResponseCopyWith(
    VaccineScheduleLogResponse value,
    $Res Function(VaccineScheduleLogResponse) then,
  ) =
      _$VaccineScheduleLogResponseCopyWithImpl<
        $Res,
...
/// @nodoc
class _$VaccineScheduleLogResponseCopyWithImpl<
  $Res,
...
class _$VaccineScheduleLogResponseImpl implements _VaccineScheduleLogResponse {
  ...
  Map<String, dynamic> toJson() {
    return _$$VaccineScheduleLogResponseImplToJson(this);
  }
}
