...
class _$MedicationDtoImpl implements _MedicationDto {
  ...
  @override
  String toString() {
    return 'MedicationDto(medicationId: $medicationId, medicationName: $medicationName, morning: $morning, afternoon: $afternoon, evening: $evening, noon: $noon, notes: $notes)';
  }
