...
abstract class $PrescriptionDtoCopyWith<$Res> {
  factory $PrescriptionDtoCopyWith(
    PrescriptionDto value,
    $Res Function(PrescriptionDto) then,
...
abstract class _$$PrescriptionDtoImplCopyWith<$Res>
    implements $PrescriptionDtoCopyWith<$Res> {
  factory _$$PrescriptionDtoImplCopyWith(
    _$PrescriptionDtoImpl value,
...
class __$$PrescriptionDtoImplCopyWithImpl<$Res>
  ...
  __$$PrescriptionDtoImplCopyWithImpl(
    _$PrescriptionDtoImpl _value,
    $Res Function(_$PrescriptionDtoImpl) _then,
  ) : super(_value, _then);
...
class _$PrescriptionDtoImpl implements _PrescriptionDto {
  ...
  @override
  String toString() {
    return 'PrescriptionDto(id: $id, prescribedDate: $prescribedDate, notes: $notes, quantityAnimal: $quantityAnimal, status: $status, price: $price, cageId: $cageId, daysToTake: $daysToTake, endDate: $endDate, symptoms: $symptoms, medications: $medications)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PrescriptionDtoImplToJson(this);
  }
}
